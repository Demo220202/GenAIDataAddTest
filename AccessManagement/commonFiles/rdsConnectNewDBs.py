...
def get_secret(env):
    ...
    if env == "prod":
        ...
        secret_name_bot = "zenarate/prod/db/labels"
        ...
        secret_name_bot = "zenarate/beta/db/labels/root"
        region_name = "us-west-1"
        return fetch_secret(secret_name_main, region_name), fetch_secret(secret_name_bot, region_name)
    elif env == "qa":
        secret_name_main = "zenarate/qa/db/main/root"
        secret_name_bot = "zenarate/qa/db/labels/root"
        region_name = "us-west-1"
        return fetch_secret(secret_name_main, region_name), fetch_secret(secret_name_bot, region_name)
    elif env == "qa2":
        secret_name_main = "zenarate/qa2/db/main/root"
        secret_name_bot = "zenarate/qa2/db/labels/root"
        region_name = "us-west-1"
        return fetch_secret(secret_name_main, region_name), fetch_secret(secret_name_bot, region_name)
    elif env == "pa":
