...
def main():
    ...
    env = "prod"
    brand_name = "Molina Healthcare" # Based on DB Name
    email = "amitj@zenarate.com" # This user must have access of the brand that we are using right now(team - mandatory)
    account_list = ["Member and Provider Contact Center"] # Team
    scenario_category = "Member and Provider Contact Center" # Sales, Marketing
